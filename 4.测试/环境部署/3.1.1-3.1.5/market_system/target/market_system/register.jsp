			...
			<form id="regForm" method="post" action="#">
				<table>
					...
					<tr>
						...
						<td><input id="userName" class="userName" type="text" name="userName" maxlength="15" onblur="CheckItem(this)"/><span class="error">字母数字下划线组成，长度4-15</span></td>
					</tr>
					<tr>
						<td class="field">登录密码：</td>
						<td><input class="pwd" type="password" id="passWord" name="passWord"   onblur="CheckItem(this)"/><span class="error">数字、字母组成,长度6位</span></td>
					</tr>
					<tr>
